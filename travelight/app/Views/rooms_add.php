            ...
            <div class="col-6">
                ...
                <form action="<?= base_url('rooms/add/save/' . $room['idHotel']) ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="wktMulai" class="form-control" id="InputForwktMulai">
                    </div>
                    <div class="mb-3">
                        <label for="InputForwktAkhir" class="form-label">Waktu Akhir Tersedia</label>
                        <input type="datetime-local" name="wktAkhir" class="form-control" id="InputForwktAkhir">
                    </div>
                    <div class="mb-3">
