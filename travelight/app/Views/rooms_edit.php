        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-6">
                ...
                <form action="<?= base_url('rooms/update/' . $room['idKamar']) ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="InputForDesc" class="form-label">Waktu Mulai Tersedia</label>
                        <input type="text" name="waktuTersedia" class="form-control" id="InputForWaktuTersedua" value="<?= $room['waktuMulaiTersedia']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="InputForUrlGbr" class="form-label">Waktu Akhir Tersedia</label>
                        <input type="datetime-local" name="waktuHabis" class="form-control" id="InputForwaktuAkhirTersedia" value="<?= $room['waktuAkhirTersedia']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="InputForUrlGbr" class="form-label">Stok</label>
